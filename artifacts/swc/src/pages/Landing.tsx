export type LandingSection = "home" | "curriculum" | "vault";
...
const s = {
  serif: { fontFamily: "'Bodoni Moda', serif" } as React.CSSProperties,
  container: { fontFamily: "'Montserrat', sans-serif", backgroundColor: "#F5F2ED", color: "#1A1A1A" } as React.CSSProperties,
  backBtn: {
    background: "none", border: "none", fontSize: "9px", textTransform: "uppercase" as const,
    letterSpacing: "0.2em", opacity: 0.4, cursor: "pointer", marginBottom: "2.5rem",
    display: "flex", alignItems: "center", gap: "0.5rem", color: "#1A1A1A", padding: 0
  } as React.CSSProperties,
  dot: { width: "6px", height: "6px", borderRadius: "50%", backgroundColor: "rgba(0,0,0,0.2)", flexShrink: 0 } as React.CSSProperties,
};

export default function Landing({ section, onNavigate }: LandingProps) {
  return (
    <div style={s.container}>
      ...
      {section === "home" && (
        <>
          <section style={{ paddingTop: "3rem", paddingBottom: "4rem", paddingLeft: "2rem", paddingRight: "2rem", textAlign: "center" }}>
            ...
            <h1 style={{ ...s.serif, fontSize: "clamp(2rem, 6vw, 3.75rem)", marginBottom: "1.5rem", lineHeight: 1.1, fontWeight: 700 }}>
              THE NEW <br />
            ...
            <div style={{
              position: "relative", margin: "3rem auto", border: "1px solid rgba(26,26,26,0.1)",
              borderRadius: "1rem", overflow: "hidden", backgroundColor: "#f3f4f6",
              aspectRatio: "16/9", display: "flex", alignItems: "center", justifyContent: "center", maxWidth: "560px"
            }}>
              ...
              <span style={{ ...s.serif, fontSize: "1.25rem", fontStyle: "italic", opacity: 0.3, padding: "0 1.5rem", textAlign: "center" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "1rem", alignItems: "center" }}>
              <button
                ...
                style={{
                  backgroundColor: "#1A1A1A", color: "#fff", padding: "1.25rem 2rem",
                  fontSize: "11px", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.3em",
          ...
          <section style={{ padding: "3rem 2rem", textAlign: "center" }}>
            <h3 style={{ ...s.serif, fontSize: "1.25rem", marginBottom: "2rem", fontStyle: "italic", fontWeight: 400 }}>
            ...
            <div style={{ display: "flex", flexWrap: "wrap", justifyContent: "center", gap: "0.5rem", maxWidth: "480px", margin: "0 auto" }}>
              {PILLS_PREVIEW.map(pill => (
                <span key={pill} style={{
                  backgroundColor: "#fff", border: "1px solid rgba(26,26,26,0.05)",
                  padding: "8px 16px", fontSize: "9px", fontWeight: 600,
                  letterSpacing: "0.1em", borderRadius: "99px", textTransform: "uppercase"
                }}>{pill}</span>
              ))}
            </div>
            <button
              onClick={() => onNavigate("curriculum")}
              style={{ marginTop: "2rem", background: "none", border: "none", fontSize: "9px", textTransform: "uppercase", letterSpacing: "0.2em", opacity: 0.4, cursor: "pointer", color: "#1A1A1A" }}
            >
              See full list of 18 →
            </button>
          </section>
          ...
          <section style={{ padding: "4rem 2rem", backgroundColor: "#f9f9f9", borderTop: "1px solid rgba(0,0,0,0.05)", borderBottom: "1px solid rgba(0,0,0,0.05)" }}>
            <h3 style={{ ...s.serif, fontSize: "1.875rem", textAlign: "center", marginBottom: "3rem", fontStyle: "italic", fontWeight: 400 }}>
              Voices of Success
            </h3>
          ...
          <section style={{ padding: "4rem 2rem", textAlign: "center" }}>
            <h3 style={{ ...s.serif, fontSize: "1.5rem", marginBottom: "1rem", fontStyle: "italic", fontWeight: 400 }}>
              Have questions?
            </h3>
            ...
            <a
              ...
              style={{ display: "inline-flex", alignItems: "center", gap: "0.5rem", fontSize: "10px", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.1em", opacity: 0.8, color: "#1A1A1A", textDecoration: "none" }}
            >
          ...
          <section style={{ padding: "4rem 2rem", textAlign: "center", backgroundColor: "#1A1A1A", color: "#fff" }}>
            <h2 style={{ ...s.serif, fontSize: "1.875rem", marginBottom: "1.5rem", fontWeight: 400 }}>
            ...
            <button
              ...
              style={{
                ...
                padding: "1.25rem", fontSize: "11px", fontWeight: 700,
                textTransform: "uppercase", letterSpacing: "0.3em", border: "none", cursor: "pointer"
              }}
            >
              Secure Access — $497
            </button>
      ...
      {section === "curriculum" && (
        <section style={{ padding: "3rem 2rem 5rem" }}>
          <button onClick={() => onNavigate("home")} style={s.backBtn}>← Back to Home</button>

          <div style={{ textAlign: "center", marginBottom: "4rem" }}>
            <h2 style={{ ...s.serif, fontSize: "clamp(2rem, 5vw, 2.5rem)", marginBottom: "0.75rem", fontStyle: "italic", fontWeight: 400 }}>
              The Roadmap
            </h2>
          ...
          <div style={{ marginBottom: "5rem" }}>
            <h3 style={{ ...s.serif, fontSize: "1.5rem", marginBottom: "2rem", paddingBottom: "1rem", borderBottom: "1px solid rgba(0,0,0,0.05)", fontWeight: 400 }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(200px, 1fr))", gap: "1rem 3rem" }}>
              {INCOME_STREAMS.map(stream => (
                <div key={stream} style={{ fontSize: "10px", textTransform: "uppercase", letterSpacing: "0.1em", display: "flex", alignItems: "center", gap: "0.75rem" }}>
                  <span style={s.dot} />
                  {stream}
                </div>
              ))}
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(200px, 1fr))" }}>
            {MODULES.map((m, i) => (
              <div
                key={i}
                style={{ display: "flex", alignItems: "center", gap: "1rem", padding: "1rem 0.5rem", borderBottom: "1px solid rgba(0,0,0,0.03)", transition: "padding-left 0.3s" }}
                onMouseEnter={e => { e.currentTarget.style.paddingLeft = "1rem"; e.currentTarget.style.backgroundColor = "rgba(0,0,0,0.02)"; }}
                onMouseLeave={e => { e.currentTarget.style.paddingLeft = "0.5rem"; e.currentTarget.style.backgroundColor = "transparent"; }}
              >
                <span style={{ fontSize: "10px", fontWeight: 700, opacity: 0.2, minWidth: "1.5rem" }}>{String(i + 1).padStart(2, "0")}</span>
                <span style={{ fontSize: "10px", textTransform: "uppercase", letterSpacing: "0.1em", fontWeight: 500, opacity: 0.8 }}>{m}</span>
              </div>
            ))}
          </div>
          ...
          <div style={{ marginTop: "5rem", padding: "2rem", backgroundColor: "#f9f9f9", borderRadius: "0.75rem", textAlign: "center", border: "1px solid rgba(0,0,0,0.05)" }}>
            <h3 style={{ ...s.serif, fontSize: "1.5rem", marginBottom: "1rem", fontStyle: "italic", fontWeight: 400 }}>Ready to start?</h3>
            <button
              onClick={() => onNavigate("vault")}
              style={{ backgroundColor: "#1A1A1A", color: "#fff", padding: "1rem 2.5rem", fontSize: "10px", textTransform: "uppercase", letterSpacing: "0.2em", fontWeight: 700, border: "none", cursor: "pointer" }}
            >
              Get Instant Access
            </button>
          </div>
        ...
        <section style={{ padding: "3rem 2rem 5rem" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "2rem", maxWidth: "520px", margin: "0 auto" }}>
            ...
            <div style={{ border: "1px solid rgba(26,26,26,0.1)", padding: "2rem", borderRadius: "1rem", backgroundColor: "#fff" }}>
              ...
              <h4 style={{ ...s.serif, fontSize: "1.5rem", marginTop: "0.5rem", marginBottom: "0.75rem", fontWeight: 400 }}>Instagram Reel Covers</h4>
            ...
            <div style={{ border: "1px solid rgba(26,26,26,0.1)", padding: "2rem", borderRadius: "1rem", backgroundColor: "#f9f9f9" }}>
              ...
              <h4 style={{ ...s.serif, fontSize: "1.5rem", marginTop: "0.5rem", marginBottom: "0.75rem", fontStyle: "italic", fontWeight: 400 }}>Caption Templates</h4>
              ...
              <div style={{ backgroundColor: "#fff", padding: "1.25rem", borderRadius: "0.5rem", border: "1px solid rgba(0,0,0,0.05)" }}>
                <p style={{ fontSize: "10px", fontWeight: 700, marginBottom: "0.5rem", textTransform: "uppercase", opacity: 0.4 }}>Template: The Result Hook</p>
                ...
                <button style={{ marginTop: "1rem", background: "none", border: "none", fontSize: "9px", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.1em", borderBottom: "1px solid #1A1A1A", cursor: "pointer", padding: 0, color: "#1A1A1A" }}>
                  Copy Template
                </button>
              </div>
            </div>
            ...
            <div style={{ backgroundColor: "#fff", border: "1px solid rgba(26,26,26,0.1)", padding: "2rem", borderRadius: "1rem", textAlign: "center" }}>
              ...
              <h4 style={{ ...s.serif, fontSize: "1.5rem", marginBottom: "0.5rem", fontStyle: "italic", fontWeight: 400 }}>Secure Enrollment</h4>
              ...
              <button style={{
                width: "100%", backgroundColor: "#1A1A1A", color: "#fff", padding: "1.25rem",
                fontSize: "11px", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.3em",
                border: "none", cursor: "pointer", boxShadow: "0 20px 40px rgba(0,0,0,0.2)"
              }}>
      ...
      <footer style={{ backgroundColor: "#f9f9f9", padding: "3rem 2rem", textAlign: "center", borderTop: "1px solid rgba(0,0,0,0.05)" }}>
        <p style={{ ...s.serif, fontStyle: "italic", fontSize: "1.125rem", marginBottom: "0.5rem" }}>SWC 2.0</p>
        ...
        <div style={{ display: "flex", justifyContent: "center", gap: "1.5rem", fontSize: "9px", textTransform: "uppercase", letterSpacing: "0.1em", opacity: 0.3 }}>
          <a href="#" style={{ color: "#1A1A1A", textDecoration: "none" }}>Privacy</a>
          <a href="#" style={{ color: "#1A1A1A", textDecoration: "none" }}>Terms</a>
          <a href="#" style={{ color: "#1A1A1A", textDecoration: "none" }}>MRR License</a>
        </div>
      </footer>
    </div>
  );
